...
let charlie = new Employee("Charlie", "Cross", "cc@gmail.com", 45);
...
class ProgressiveManager extends Manager {
  ...
  } // to keep this unique to ProgressiveManager you have to create the function as if hire(employee) was brand new
...
class Machine {
  ...
  makeWidgets(num) {
    ...
    this.wear_and_tear_count += Number(num / 50);
  }
